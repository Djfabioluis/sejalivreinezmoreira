...
-- Corrigir a função append_wa_message removendo a referência à coluna inexistente 'created_at'
...
BEGIN
  ...
  -- 2. Se não existir, criar (removida coluna created_at que não existe na tabela)
