...
import { ensureCustomerMemory, loadCustomerMemory, persistExtractedMemory, recordAppointmentLearning, } from "./store.server";
...
async function learnFromRecentAppointments(params) {
...
export async function learnFromInteraction(params) {
    try {
        ...
        const memory = (await loadCustomerMemory({ phone: params.phone, orgKey })) ??
