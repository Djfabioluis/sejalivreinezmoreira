...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Seja Livre — Secretária virtual" },
      { name: "description", content: "Painel e secretária virtual da clínica Seja Livre by Inez Moreira." },
      { name: "author", content: "Seja Livre" },
      { property: "og:title", content: "Seja Livre — Secretária virtual" },
      { property: "og:description", content: "Agenda em tempo real, IA de agendamento e base de conhecimento em um só lugar." },
